...
<div class="" data-kt-search-element="main">
	...
	<div class="d-flex flex-stack fw-semibold mb-4">
		...
		<div class="d-flex" data-kt-search-element="toolbar">
			...
			<div data-kt-search-element="preferences-show" class="btn btn-icon w-20px btn-sm btn-active-color-primary me-2 data-bs-toggle=" title="Show search preferences">{!! getIcon('setting-2', 'fs-2') !!}</div>
			<!--end::Preferences toggle-->
			<!--begin::Advanced search toggle-->
			<div data-kt-search-element="advanced-options-form-show" class="btn btn-icon w-20px btn-sm btn-active-color-primary me-n1" data-bs-toggle="tooltip" title="Show more search options">{!! getIcon('down', 'fs-2') !!}</div>
